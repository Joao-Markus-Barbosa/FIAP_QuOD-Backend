...
public class RegistroValidacaoFacial {
    ...
    private String motivoFalha;     // Ex: "deepfake", "imagem suspeita", etc
    ...
    public RegistroValidacaoFacial() {
    }

    public RegistroValidacaoFacial(String cpf, String imagemBase64, String statusValidacao,
